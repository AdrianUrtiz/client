        ...
        <div className='container mx-auto w-full'>
          <div className='py-5 px-4 flex justify-between flex-wrap sm:flex-no-wrap md:flex-wrap items-center text-white'>
            <div className='flex flex-row gap-6'>
              ...
              <div className='mx-3 text-center hidden xl:block'>
                <span></span>
              </div>
            </div>
            ...
            <div
              ...
              <ul className='flex flex-col duration-300 ease-out sm:transition-none gap-4  md:flex-row my-10 md:my-0'>
                {navTopLinks.map((link, i) => (
                  <li key={i} className='font-base font-medium group relative'>
                    <Link href={link.href}>
